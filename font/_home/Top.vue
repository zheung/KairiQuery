	...
	export default {
		data: function() {
			return {
				...
				jput: moment('2018-05-15 12:31:00').fromNow().replace(/ /g, ''),
				wsut: moment('2018-05-02 17:30:00').fromNow().replace(/ /g, '')
			};
		}
	};
</script>
...
<style scoped>
	.homeTopBox {
		...
		background-image: linear-gradient(-173deg, #2e3235 45%, #444d52 85%);

		box-shadow: 0px 2px 5px 0px rgba(46, 50, 53, 0.5);
