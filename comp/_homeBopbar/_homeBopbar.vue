<template>
	<div class="homeBopBar trans" :class="{ hidding: hidebar }" >
...
<style scoped>
	...
	.item:hover {
		...
		box-shadow: 0px -2px 5px 0px rgba(67, 122, 146, 0.5);
	}
