module.exports = async(serv, card) => {
	...
	let result = {},
		skillTypes = ['awaken', 'normal', 'suport1', 'suport2', 'suport3', 'call'],
		skills = card.skill;
